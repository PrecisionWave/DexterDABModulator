...
proc create_hier_cell_accel { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_accel() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 apu2cpu_axi

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 cpu2apu_axi


  # Create pins
  create_bd_pin -dir O -type intr apu_mbx_irq
  create_bd_pin -dir O -type intr apu_uart_irq
  create_bd_pin -dir I -type rst ext_reset_in
  ...
  # Create instance: VexiiRiscv_wrapper_0, and set properties
  set block_name VexiiRiscv_wrapper
  set block_cell_name VexiiRiscv_wrapper_0
  if { [catch {set VexiiRiscv_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $VexiiRiscv_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: apu_tsc, and set properties
  set apu_tsc [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_counter_binary:12.0 apu_tsc ]
  set_property -dict [ list \
   CONFIG.Load {false} \
  ...
  # Create instance: cpu_mb_control, and set properties
  set cpu_mb_control [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 cpu_mb_control ]
  set_property -dict [ list \
  ...
  # Create instance: cpu_shared_bram_ctrl, and set properties
  set cpu_shared_bram_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 cpu_shared_bram_ctrl ]
  set_property -dict [ list \
  ...
  set mb_axi_intc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 mb_axi_intc ]
  set_property -dict [ list \
   CONFIG.C_HAS_FAST {1} \
 ] $mb_axi_intc

  # Create instance: mb_axi_per, and set properties
  set mb_axi_per [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 mb_axi_per ]
  set_property -dict [ list \
   CONFIG.NUM_MI {4} \
 ] $mb_axi_per

  # Create instance: mb_axi_timer, and set properties
  set mb_axi_timer [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 mb_axi_timer ]

  # Create instance: mb_int_concat, and set properties
  set mb_int_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 mb_int_concat ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $mb_int_concat

  # Create instance: mb_rstgen, and set properties
  set mb_rstgen [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 mb_rstgen ]
  set_property -dict [ list \
   CONFIG.C_AUX_RESET_HIGH {1} \
   CONFIG.C_EXT_RST_WIDTH {1} \
 ] $mb_rstgen

  # Create instance: mb_shared_bram_ctrl, and set properties
  set mb_shared_bram_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 mb_shared_bram_ctrl ]
  set_property -dict [ list \
   CONFIG.SINGLE_PORT_BRAM {1} \
 ] $mb_shared_bram_ctrl
  ...
  set shared_mailbox [ create_bd_cell -type ip -vlnv xilinx.com:ip:mailbox:2.1 shared_mailbox ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins VexiiRiscv_wrapper_0/LsuL1] [get_bd_intf_pins mb_axi_cache/S00_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXI_1] [get_bd_intf_pins VexiiRiscv_wrapper_0/LsuL1] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins VexiiRiscv_wrapper_0/FetchL1] [get_bd_intf_pins mb_axi_cache/S01_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets S01_AXI_1] [get_bd_intf_pins VexiiRiscv_wrapper_0/FetchL1] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net VexiiRiscv_wrapper_0_LsuCacheless [get_bd_intf_pins VexiiRiscv_wrapper_0/LsuCacheless] [get_bd_intf_pins mb_axi_per/S00_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets VexiiRiscv_wrapper_0_LsuCacheless] [get_bd_intf_pins VexiiRiscv_wrapper_0/LsuCacheless] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_intf_net -intf_net cpu_cpu2apu_axi_M01_AXI [get_bd_intf_pins cpu_apuuart/S_AXI] [get_bd_intf_pins cpu_cpu2apu_axi/M01_AXI]
  connect_bd_intf_net -intf_net cpu_cpu2apu_axi_M02_AXI [get_bd_intf_pins cpu_cpu2apu_axi/M02_AXI] [get_bd_intf_pins cpu_mb_control/S_AXI]
  connect_bd_intf_net -intf_net cpu_cpu2apu_axi_M04_AXI [get_bd_intf_pins axi_firewall_0/S_AXI_CTL] [get_bd_intf_pins cpu_cpu2apu_axi/M04_AXI]
  ...
  connect_bd_intf_net -intf_net mb_axi_cache_M01_AXI [get_bd_intf_pins axi_firewall_0/S_AXI] [get_bd_intf_pins mb_axi_cache/M01_AXI]
  connect_bd_intf_net -intf_net mb_axi_per_M02_AXI [get_bd_intf_pins mb_axi_per/M02_AXI] [get_bd_intf_pins mb_uartlite/S_AXI]
  connect_bd_intf_net -intf_net mb_axi_per_M03_AXI [get_bd_intf_pins mb_axi_per/M03_AXI] [get_bd_intf_pins mb_axi_timer/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins mb_axi_cache/ARESETN] [get_bd_pins mb_axi_cache/M00_ARESETN] [get_bd_pins mb_axi_cache/M01_ARESETN] [get_bd_pins mb_axi_cache/S00_ARESETN] [get_bd_pins mb_axi_cache/S01_ARESETN] [get_bd_pins mb_axi_per/ARESETN] [get_bd_pins mb_axi_per/M00_ARESETN] [get_bd_pins mb_axi_per/M01_ARESETN] [get_bd_pins mb_axi_per/M02_ARESETN] [get_bd_pins mb_axi_per/M03_ARESETN] [get_bd_pins mb_axi_per/S00_ARESETN] [get_bd_pins mb_rstgen/interconnect_aresetn]
  connect_bd_net -net M03_ARESETN_1 [get_bd_pins sys_rstn] [get_bd_pins axi_firewall_0/aresetn] [get_bd_pins cpu_apuuart/s_axi_aresetn] [get_bd_pins cpu_cpu2apu_axi/ARESETN] [get_bd_pins cpu_cpu2apu_axi/M00_ARESETN] [get_bd_pins cpu_cpu2apu_axi/M01_ARESETN] [get_bd_pins cpu_cpu2apu_axi/M02_ARESETN] [get_bd_pins cpu_cpu2apu_axi/M03_ARESETN] [get_bd_pins cpu_cpu2apu_axi/M04_ARESETN] [get_bd_pins cpu_cpu2apu_axi/S00_ARESETN] [get_bd_pins cpu_mb_control/s_axi_aresetn] [get_bd_pins cpu_shared_bram_ctrl/s_axi_aresetn] [get_bd_pins shared_mailbox/S0_AXI_ARESETN] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net Net [get_bd_pins VexiiRiscv_wrapper_0/reset] [get_bd_pins apu_tsc/SCLR] [get_bd_pins mb_axi_intc/processor_rst] [get_bd_pins mb_rstgen/mb_reset] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net VexiiRiscv_wrapper_0_EmbeddedRiscvJtag_logic_jtag_tdo [get_bd_pins jtag_tdo] [get_bd_pins VexiiRiscv_wrapper_0/EmbeddedRiscvJtag_logic_jtag_tdo]
  connect_bd_net -net VexiiRiscv_wrapper_0_EmbeddedRiscvJtag_logic_ndmreset [get_bd_pins VexiiRiscv_wrapper_0/EmbeddedRiscvJtag_logic_ndmreset] [get_bd_pins mb_rstgen/mb_debug_sys_rst] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net apu_tsc_Q [get_bd_pins VexiiRiscv_wrapper_0/PrivilegedPlugin_logic_rdtime] [get_bd_pins apu_tsc/Q]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins cpu_mb_control/gpio2_io_o] [get_bd_pins mb_rstgen/aux_reset_in] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins mb_axi_timer/interrupt] [get_bd_pins mb_int_concat/In2]
  ...
  connect_bd_net -net jtag_tck_1 [get_bd_pins jtag_tck] [get_bd_pins VexiiRiscv_wrapper_0/EmbeddedRiscvJtag_logic_jtag_tck]
  connect_bd_net -net jtag_tdi_1 [get_bd_pins jtag_tdi] [get_bd_pins VexiiRiscv_wrapper_0/EmbeddedRiscvJtag_logic_jtag_tdi]
  connect_bd_net -net jtag_tms_1 [get_bd_pins jtag_tms] [get_bd_pins VexiiRiscv_wrapper_0/EmbeddedRiscvJtag_logic_jtag_tms]
  ...
  connect_bd_net -net mb_axi_intc_irq [get_bd_pins VexiiRiscv_wrapper_0/PrivilegedPlugin_logic_harts_0_int_m_external] [get_bd_pins mb_axi_intc/irq]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins sys_clk] [get_bd_pins VexiiRiscv_wrapper_0/clk] [get_bd_pins apu_tsc/CLK] [get_bd_pins axi_firewall_0/aclk] [get_bd_pins cpu_apuuart/s_axi_aclk] [get_bd_pins cpu_cpu2apu_axi/ACLK] [get_bd_pins cpu_cpu2apu_axi/M00_ACLK] [get_bd_pins cpu_cpu2apu_axi/M01_ACLK] [get_bd_pins cpu_cpu2apu_axi/M02_ACLK] [get_bd_pins cpu_cpu2apu_axi/M03_ACLK] [get_bd_pins cpu_cpu2apu_axi/M04_ACLK] [get_bd_pins cpu_cpu2apu_axi/S00_ACLK] [get_bd_pins cpu_mb_control/s_axi_aclk] [get_bd_pins cpu_shared_bram_ctrl/s_axi_aclk] [get_bd_pins mb_axi_cache/ACLK] [get_bd_pins mb_axi_cache/M00_ACLK] [get_bd_pins mb_axi_cache/M01_ACLK] [get_bd_pins mb_axi_cache/S00_ACLK] [get_bd_pins mb_axi_cache/S01_ACLK] [get_bd_pins mb_axi_intc/processor_clk] [get_bd_pins mb_axi_intc/s_axi_aclk] [get_bd_pins mb_axi_per/ACLK] [get_bd_pins mb_axi_per/M00_ACLK] [get_bd_pins mb_axi_per/M01_ACLK] [get_bd_pins mb_axi_per/M02_ACLK] [get_bd_pins mb_axi_per/M03_ACLK] [get_bd_pins mb_axi_per/S00_ACLK] [get_bd_pins mb_axi_timer/s_axi_aclk] [get_bd_pins mb_rstgen/slowest_sync_clk] [get_bd_pins mb_shared_bram_ctrl/s_axi_aclk] [get_bd_pins mb_uartlite/s_axi_aclk] [get_bd_pins shared_mailbox/S0_AXI_ACLK] [get_bd_pins shared_mailbox/S1_AXI_ACLK] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net microblaze_0_intr [get_bd_pins mb_axi_intc/intr] [get_bd_pins mb_int_concat/dout]
  connect_bd_net -net sys_rstgen1_peripheral_aresetn [get_bd_pins mb_axi_intc/s_axi_aresetn] [get_bd_pins mb_axi_timer/s_axi_aresetn] [get_bd_pins mb_rstgen/peripheral_aresetn] [get_bd_pins mb_shared_bram_ctrl/s_axi_aresetn] [get_bd_pins mb_uartlite/s_axi_aresetn] [get_bd_pins shared_mailbox/S1_AXI_ARESETN]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins VexiiRiscv_wrapper_0/PrivilegedPlugin_logic_harts_0_int_m_software] [get_bd_pins VexiiRiscv_wrapper_0/PrivilegedPlugin_logic_harts_0_int_m_timer] [get_bd_pins gnd/dout]
...
proc create_root_design { parentCell } {
  ...
  set axss_reg [ create_bd_port -dir I -from 31 -to 0 axss_reg ]
  ...
  # Create instance: axss_gpio, and set properties
  set axss_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axss_gpio ]
  set_property -dict [ list \
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 0#UART 0#GPIO#GPIO#SD 0#GPIO#Enet 0#Enet 0}\
  ...
  # Create instance: xlconcat_bit3, and set properties
  set xlconcat_bit3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 xlconcat_bit3 ]
  ...
  # Create instance: xlslice_bit2, and set properties
  set xlslice_bit2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_bit2 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {2} \
   CONFIG.DIN_TO {2} \
   CONFIG.DIN_WIDTH {3} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net accel_M00_AXI [get_bd_intf_pins accel/apu2cpu_axi] [get_bd_intf_pins sys_ps7/S_AXI_HP2]
  ...
  connect_bd_intf_net -intf_net debug_bridge_0_m1_bscan [get_bd_intf_pins debug_bridge_0/m1_bscan] [get_bd_intf_pins debug_bridge_1/S_BSCAN]
  ...
  connect_bd_intf_net -intf_net sys_ps7_axi_periph_M04_AXI [get_bd_intf_pins axss_gpio/S_AXI] [get_bd_intf_pins sys_ps7_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net sys_ps7_axi_periph_M05_AXI [get_bd_intf_pins accel/cpu2apu_axi] [get_bd_intf_pins sys_ps7_axi_periph/M05_AXI]

  # Create port connections
  connect_bd_net -net accel_Interrupt_0 [get_bd_pins accel/apu_mbx_irq] [get_bd_pins sys_concat_intc/In2]
  connect_bd_net -net accel_interrupt [get_bd_pins accel/apu_uart_irq] [get_bd_pins sys_concat_intc/In4]
  connect_bd_net -net accel_jtag_tdo [get_bd_pins accel/jtag_tdo] [get_bd_pins xlconcat_bit3/In0]
  ...
  connect_bd_net -net gnd_dout [get_bd_pins gnd/dout] [get_bd_pins sys_concat_intc/In3] [get_bd_pins sys_concat_intc/In5] [get_bd_pins sys_concat_intc/In6] [get_bd_pins sys_concat_intc/In7] [get_bd_pins sys_concat_intc/In8] [get_bd_pins sys_concat_intc/In9] [get_bd_pins sys_concat_intc/In10] [get_bd_pins sys_concat_intc/In11] [get_bd_pins sys_concat_intc/In12] [get_bd_pins sys_concat_intc/In13] [get_bd_pins sys_concat_intc/In14] [get_bd_pins sys_concat_intc/In15]
  connect_bd_net -net gpio_i_1 [get_bd_ports gpio_i] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net gpio_io_i_0_1 [get_bd_ports axss_reg] [get_bd_pins axss_gpio/gpio_io_i]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports sys_cpu_clk] [get_bd_pins accel/sys_clk] [get_bd_pins axi_dmac_0/m_src_axi_aclk] [get_bd_pins axi_dmac_0/s_axi_aclk] [get_bd_pins axi_dmac_1/m_src_axi_aclk] [get_bd_pins axi_dmac_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axss_gpio/s_axi_aclk] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins debug_bridge_1/clk] [get_bd_pins sys_ps7/FCLK_CLK0] [get_bd_pins sys_ps7/M_AXI_GP0_ACLK] [get_bd_pins sys_ps7/S_AXI_HP1_ACLK] [get_bd_pins sys_ps7/S_AXI_HP2_ACLK] [get_bd_pins sys_ps7_axi_periph/ACLK] [get_bd_pins sys_ps7_axi_periph/M00_ACLK] [get_bd_pins sys_ps7_axi_periph/M02_ACLK] [get_bd_pins sys_ps7_axi_periph/M03_ACLK] [get_bd_pins sys_ps7_axi_periph/M04_ACLK] [get_bd_pins sys_ps7_axi_periph/M05_ACLK] [get_bd_pins sys_ps7_axi_periph/S00_ACLK] [get_bd_pins sys_rstgen/slowest_sync_clk]
  ...
  connect_bd_net -net sys_ps7_FCLK_RESET0_N [get_bd_pins accel/ext_reset_in] [get_bd_pins adc_if/ext_reset_in] [get_bd_pins rst_164M/ext_reset_in] [get_bd_pins sys_ps7/FCLK_RESET0_N] [get_bd_pins sys_rstgen/ext_reset_in]
  ...
  connect_bd_net -net sys_rstgen_peripheral_aresetn [get_bd_ports sys_cpu_resetn] [get_bd_pins accel/sys_rstn] [get_bd_pins axi_dmac_0/m_src_axi_aresetn] [get_bd_pins axi_dmac_0/s_axi_aresetn] [get_bd_pins axi_dmac_1/m_src_axi_aresetn] [get_bd_pins axi_dmac_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axss_gpio/s_axi_aresetn] [get_bd_pins debug_bridge_0/s_axi_aresetn] [get_bd_pins sys_ps7_axi_periph/ARESETN] [get_bd_pins sys_ps7_axi_periph/M00_ARESETN] [get_bd_pins sys_ps7_axi_periph/M02_ARESETN] [get_bd_pins sys_ps7_axi_periph/M03_ARESETN] [get_bd_pins sys_ps7_axi_periph/M04_ARESETN] [get_bd_pins sys_ps7_axi_periph/M05_ARESETN] [get_bd_pins sys_ps7_axi_periph/S00_ARESETN] [get_bd_pins sys_rstgen/peripheral_aresetn]
  connect_bd_net -net vcc_dout [get_bd_pins sys_ps7/SPI0_SS_I] [get_bd_pins vcc/dout]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins sys_ps7/GPIO_I] [get_bd_pins xlconcat_bit3/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins xlslice_bit0/Din] [get_bd_pins xlslice_bit1/Din] [get_bd_pins xlslice_bit2/Din]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlconcat_bit3/In1] [get_bd_pins xlslice_1/Dout]
  ...
  connect_bd_net -net xlslice_bit0_Dout [get_bd_pins accel/jtag_tck] [get_bd_pins xlslice_bit0/Dout]
  connect_bd_net -net xlslice_bit1_Dout [get_bd_pins accel/jtag_tms] [get_bd_pins xlslice_bit1/Dout]
  connect_bd_net -net xlslice_bit2_Dout [get_bd_pins accel/jtag_tdi] [get_bd_pins xlslice_bit2/Dout]
  ...
  assign_bd_address -offset 0x44060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs accel/axi_firewall_0/S_AXI_CTL/Control] -force
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/LsuCacheless] [get_bd_addr_segs accel/mb_axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0x41C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/LsuCacheless] [get_bd_addr_segs accel/mb_axi_timer/S_AXI/Reg] -force
  assign_bd_address -offset 0x20000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/LsuL1] [get_bd_addr_segs accel/mb_shared_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x20000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/FetchL1] [get_bd_addr_segs accel/mb_shared_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x40600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/LsuCacheless] [get_bd_addr_segs accel/mb_uartlite/S_AXI/Reg] -force
  assign_bd_address -offset 0x43600000 -range 0x00010000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/LsuCacheless] [get_bd_addr_segs accel/shared_mailbox/S1_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/LsuL1] [get_bd_addr_segs sys_ps7/S_AXI_HP2/HP2_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces accel/VexiiRiscv_wrapper_0/FetchL1] [get_bd_addr_segs sys_ps7/S_AXI_HP2/HP2_DDR_LOWOCM] -force
